...
- GrenadeThrowRangeFixConfig.cs: Example of ModConfig for custom mod settings;
- GrenadeThrowRangeFixGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- GrenadeThrowRangeFixMain.cs: Main mod class, recieves mod management and general events;
- GrenadeThrowRangeFixTactical.cs: Example of ModTactical for modifying tactical level;
