...
namespace GrenadeThrowRangeFix
{
	...
	public class GrenadeThrowRangeFixGSInstanceData
	{
	...
	/// </summary>
	public class GrenadeThrowRangeFixGeoscape : ModGeoscape
	{
		/// <summary>
		...
		public override object RecordGeoscapeInstanceData() {
			return new GrenadeThrowRangeFixGSInstanceData() { ExampleData = 5 };
		}
		/// <summary>
		...
		public override void ProcessGeoscapeInstanceData(object instanceData) {
			GrenadeThrowRangeFixGSInstanceData data = (GrenadeThrowRangeFixGSInstanceData)instanceData;
		}
