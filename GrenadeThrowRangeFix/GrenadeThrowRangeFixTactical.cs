...
namespace GrenadeThrowRangeFix
{
	...
	public class GrenadeThrowRangeFixTacInstanceData
	{
	...
	/// </summary>
	public class GrenadeThrowRangeFixTactical : ModTactical
	{
		/// <summary>
		...
		public override void OnTacticalStart() {
			...
			GrenadeThrowRangeFixMain main = (GrenadeThrowRangeFixMain)Main;
		}
		/// <summary>
		...
		public override void ProcessTacticalInstanceData(object instanceData) {
			GrenadeThrowRangeFixTacInstanceData data = (GrenadeThrowRangeFixTacInstanceData)instanceData;
		}
		/// <summary>
		...
		public override object RecordTacticalInstanceData() {
			 return new GrenadeThrowRangeFixTacInstanceData() { ExampleData = 5 };
		}
		/// <summary>
